...
class Ghost
{
  ...
  void powerPellet(int p)
  {
    ...
    if(a == null)
    {
      ...
      for(int j = 0; j <= 4; j++)
      {
        a[j] = int(random(25, displayWidth - 25));
        b[j] = int(random(25, displayHeight - 25));
      }  
    }
    ...
    if ( pellet == 6)
    {
      ...
      a[4] = int(random(25, displayWidth - 25));
      b[4] = int(random(25, displayHeight - 25));
    }
    ...
    for(int l = 0; l <= pellet-1; l++)
    {
      ...
      {
        a[l] = int(random(25, displayWidth - 25));
        b[l] = int(random(25, displayHeight - 25));
