...
public class WakkaWakka extends PApplet {
...
public class Game
{
  ...
  //--------------------------------------------------------------------------------------//
  // This method is resonsible for drawing the final screen after the game is over.  It 
...
//*Name: ---------> Description (Data Type)*
//
// a: ------------> Array used to log location of Power Pellets(int array)
...
class Ghost
{
  ...
  //  then draws the exisiting Power Pellets.  It gets the number of Power Pellets in 
  //  existence from Game.powerPellets, which is iterated duing Wakka Wakka.  x and y are
  ...
  public void powerPellet(int p)
  {
    ...
    if(a == null)
    {
      ...
      for(int j = 0; j <= 4; j++)
      {
        a[j] = PApplet.parseInt(random(25, displayWidth - 25));
    ...
    if ( pellet == 6)
    {
      ...
      a[4] = PApplet.parseInt(random(25, displayWidth - 25));
      b[4] = PApplet.parseInt(random(25, displayHeight - 25));
    }
    ...
    for(int l = 0; l <= pellet-1; l++)
    {
      ...
      if(sqrt(sq(abs(WakX-a[l]))+sq(abs(WakY-b[l]))) <= 95) 
      {
        thomasthetrain = true;
      }
      ...
      {
        a[l] = PApplet.parseInt(random(25, displayWidth - 25));
...
// void getInput() --------> Recieves an input from the user and determines the direction
//                           Wakka Wakka will go
...
class WakkaWakkaDude
{
  ...
  //--------------------------------------------------------------------------------------//
  // This method is responsible for calculating the Waka Waka's new position.  It also 
...
//*--------------------------------------------------------------------------------------*//
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "WakkaWakka" };
    if (passedArgs != null) {
